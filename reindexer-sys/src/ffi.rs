...
extern "C" {
    ...
    pub fn re_client_open_namespace(
        db: *mut CReindexer,
        ns: *const c_char,
    ...
    pub fn re_client_select(
        db: *mut CReindexer,
        qr: *mut CQueryResults,
        query: *const c_char,
    ) -> bool;
    ...
    pub fn re_connect(db: *mut Reindexer, dsn: *const c_char) -> bool;
